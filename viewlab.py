        ...
        html.Div(
            [
                ...
                html.Div(
                    [
                        dcc.Graph(
                            id="graph", figure={"layout": go.Layout(height=1100)}
                        ),
                        # фото кота
                        html.Div(
                            [
                    ...
                    [
                        ...
                        html.Div(
                            [
                                ...
                                dcc.Input(
                                    id="function", type="text", value="x**2+y**2"
                                ),
                            ],
                            style={
                                "border": "1px solid black",
                        ...
                        html.Div(
                            [
                                html.Label(
                                    "Максимальные шаги:", style={"margin-top": "10px"}
                                ),
                                daq.NumericInput(
                                    id="max-steps",
                                    min=10,
                                        ...
                                        dcc.Dropdown(
                                            ...
                                            options=(
                                                lr_opts := list(
                                                    map(
                                                        attrgetter("__name__"),
                                                        Settings.LearningRateStrategies,
                                                    )
                                                )
                                            ),
                                            value=lr_opts[0],
                        ...
                        html.Div(
                            [
                                html.P(
                                    "Граница дельты f:", style={"margin-top": "10px"}
                                ),
                                daq.BooleanSwitch(
                                    id="deltaf",
                                    on=True,
                                    label="delta f(x, y) < delta_f_threshold",
                                ),
                                html.Label(
                                    "Граница дельты f:",
                                    style={
                        ...
                        html.Div(
                            [
                                ...
                                daq.BooleanSwitch(
                                    id="deltaxy",
                                    on=True,
                                    label="||(Δxk, Δyk)|| < delta_xy_threshold",
                                ),
                                html.Label(
                                    "Граница дельты xy:",
                                    style={
...
def update_graph(
            ...
            for i, point in enumerate(path):
                fig.add_trace(
                    go.Scatter3d(
                        x=[point[0]],
                        y=[point[1]],
                        z=[plotable_f([point[0], point[1]])],
                        mode="markers",
                        showlegend=False,
                        marker=dict(size=6),
                        line=dict(width=5, color=get_color(i, len(path))),
                    )
                )
            ...
            for i, simplex in enumerate(simplexes):
                fig.add_trace(
                    go.Scatter3d(
                        x=simplex[:, 0],
                        y=simplex[:, 1],
                        z=plotable_f([simplex[:, 0], simplex[:, 1]]),
                        mode="lines+markers",
                        showlegend=False,
                        marker=dict(size=6),
    ...
    fig.update_layout(
        scene=dict(
            zaxis=dict(nticks=10, range=[z_lower_limit, z_upper_limit]),
