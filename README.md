...
`git clone ...`
Основной файл `viewlab.py`, который запускает сервер по адресу `127.0.0.1:8050`. Установка требует использования виртуального окружения Python. Соответственно, надо создать окружение `python3 -m venv .venv` и установить зависимости `pip install -r req.txt`.
...
сравнение скорости рахных методов
